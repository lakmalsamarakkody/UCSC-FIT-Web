...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'student.application.submit.check' => \App\Http\Middleware\Portal\Student\Registration\ApplicationSubmitCheck::class,
        'student.payment.view' => \App\Http\Middleware\Portal\Student\Payment\ViewPaymentPage::class,
        'student.registration.payment.submit.check' => \App\Http\Middleware\Portal\Student\Payment\PaymentSubmitCheck::class,
