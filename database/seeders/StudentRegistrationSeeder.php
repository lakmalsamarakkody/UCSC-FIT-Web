            ...
            DB::table('student_registrations')->insert(
                array(
                    [
                        ...
                        'application_status' => $faker->randomElement($array = array (null)),
                        'document_submit' => $faker->numberBetween($min = 0, $max = 1),
                        'document_status' => $faker->randomElement($array = array (null)),
                        'payment_id'=>$faker->unique()->numberBetween($min = 1, $max = 100),
                        'payment_status' => $faker->randomElement($array = array (null)),
