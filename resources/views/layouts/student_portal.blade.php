          ...
          <div class="row">
            ...
            <div class="user w-100 text-center">
              <div class="img mt-3 mb-2">
                <img src="@if($student){{ asset('storage/portal/avatar/'.$student->user_id.'/'.$student->user->profile_pic)}}@endif" alt="Avatar" class="avatar" width="50%" onError="this.onerror=null;this.src='{{ asset('img/portal/avatar/default.jpg') }}';">
              </div>
