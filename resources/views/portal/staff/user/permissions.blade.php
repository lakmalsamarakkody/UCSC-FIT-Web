                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="form-group form-check">
                              <input type="checkbox" class="form-check-input" value="{{ $permission->name }}" @if(App\Models\User\Role\hasPermission::where('role_id', $selectedUserRole)->where('permission_id', $permission->id)->first()) checked @endif/>
