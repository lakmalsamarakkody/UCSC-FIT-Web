...
@section('content')
    ...
    <section id="hero" style="background-image: url({{ asset('img/background/back.jpg') }}); height:200px">
        <div class="page-hero-container">
            <h1 style="padding-top:30px">PRIVACY POLICY</h1>
        </div>
    </section><!-- #hero -->
    ...
    <main id="main">
        ...
        <div class="col-12 p-5">
            ...
            <p>Welcome to <b> Foundation of Informaion Technology</b>.</p>
            <p><b>University of Colombo School of Computing</b> (“us”, “we”, or “our”) operates <b>http://fit.bit.lk/</b> (hereinafter referred to as <b>“Service”</b>).</p>
            <p>Our Privacy Policy governs your visit to <b>http://fit.bit.lk/</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
            ...
            <p><b>SERVICE</b> means the http://fit.bit.lk/ website operated by University of Colombo School of Computing.</p>
            ...
            <p>University of Colombo School of Computing uses the collected data for various purposes:</p>
            ...
            <p>University of Colombo School of Computing will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
            ...
            <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>{{ App\Models\Contact::where('type', 'admin')->first()->email }}</b>.</p>
            ...
            <p>0.4. users are able to change their personal information by emailing us at <b>{{ App\Models\Contact::where('type', 'admin')->first()->email }}</b>.</p>
            ...
            <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>{{ App\Models\Contact::where('type', 'admin')->first()->email }}</b>.</p>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us by email: <b>{{ App\Models\Contact::where('type', 'admin')->first()->email }}</b>.</p>
