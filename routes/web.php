...
Route::post('/portal/student/information/upload/profilePic', [App\Http\Controllers\Portal\Student\InformationController::class, 'selectProfilePic'])->name('select.profile.pic');
// /INFROMATION PAGE
