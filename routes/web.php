...
Route::post('/portal/staff/exams/schedule/decline/message',[App\Http\Controllers\Portal\Staff\ExamsController::class, 'getDeclineMessage'])->name('schedule.decline.message');
