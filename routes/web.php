...
Route::post('/portal/staff/system/exam/duration/set', [App\Http\Controllers\Portal\Staff\SystemController::class, 'createExamDuration'])->name('staff.system.exam.duration.set');
